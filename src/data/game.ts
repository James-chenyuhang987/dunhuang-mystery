...
const terracottaLevels: level[] = [
    ...
    clues: [
      { type: "text", name: "北魏——窟体岩壁的凹陷", problem_indexes: [0], placement: "窟体岩壁", media_note: "表面岩层", data: "岩壁以砂岩为主，虽然易于开采，但是其本质是碳酸盐矿物，易风化。而当时土木工程技术不完善，所以是否建成了呢？太和年间，最初规划以“斩山为壁——向内掘进”的流程建造，但迁都洛阳后，经济重心南移，因此窟壁的开凿断面和地面的取石沟槽都留给后续朝代来建造。" },
      { type: "text", name: "初唐——中央大佛", problem_indexes: [1], placement: "中央大佛上身中央", media_note: "中央大佛全身照", data: "唐代利用北魏已完成的岩体框架，在此基础上雕刻了“一佛二菩萨”，十米主佛面相丰腴饱满，与北魏“秀骨清像”的清瘦风格完全不同。这样既减少了工作量，又延续了石窟的宗教供奉功能，造就一窟跨两朝的独特奇观。" },
      { type: "text", name: "辽金——主佛周身的密集小孔", problem_indexes: [2], placement: "主佛周身的密集小孔，任意一个都可", media_note: "钻孔特写", data: "砂岩易受风化，因此后世人们需要附着黄泥以进行雕刻精修。为了使石像外部美观，工匠遇到了砂岩表面光滑导致泥皮附着力不足等问题，最终采用钻孔的方式，将木楔打入，以此为骨架，在外露部分表面进行敷泥塑形，贴金彩绘。" }
    ],
    problems: [
      { title: "你可以从图中找出北魏工程戛然而止的标志吗？", select: ["大佛钻孔", "砂岩风化裂痕", "取石沟槽", "泥皮"], true_answer: 2, reason: "请结合已解锁线索与题干进行判断。" },
      { title: "即便与北魏原设计不同，唐代工程有什么优势", select: ["减少工程量", "延续宗教功能", "更美观", "中外融合"], true_answer: 1, true_answers: [0, 1], reason: "请结合已解锁线索与题干进行判断。" },
      { title: "人们能看见哪些修复痕迹？", select: ["砂岩", "泥皮", "木楔", "大佛钻孔"], true_answer: 1, true_answers: [1, 3], reason: "请结合已解锁线索与题干进行判断。" }
    ],
  },
    {
    name: "云冈石窟第五窟",
    ...
    clues: [
      ...
      { type: "text", name: "都城搬走后石窟会怎样", problem_indexes: [2], data: "公元494年，孝文帝将都城从平城迁往洛阳。随着政治中心转移，皇家大型工程减少，云冈进入晚期营建阶段，但并没有完全停工，仍在继续营造中小型洞窟。造像风格也受到洛阳汉文化审美影响，逐渐从早期雄健厚重的样式向“秀骨清像”过渡。" }
    ],
    problems: [
  ...
  },
  {
    ...
    problems: [
      ...
      { title: "佛教造像采用中原“褒衣博带”等服饰特点，说明艺术在传播过程中发生了哪些变化？", select: ["佛教艺术会吸收当地的服饰和审美特点", "外来的艺术形式在传播过程中发生了本土化变化", "不同文化之间会相互接触、借鉴和影响", "佛像必须完全保持最初传入中国时的造型，不能发生任何变化"], true_answer: 0, true_answers: [0, 1, 2], reason: "请结合已解锁线索与题干进行判断。" },
